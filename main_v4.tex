...
\paragraph{Representation of Groundwater/Surface water split.} Prior work applied GCAM's basin-level gw/sw split uniformly across cells within each basin. This dataset uses Eq.~(\ref{eq:source-shares}) to blend the temporal evolution of GCAM-USA with USGS's latest data based on the number of surface and groundwater. 
